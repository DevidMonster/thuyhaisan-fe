...
const AdminLayout = () => {
   ...
   const ButtonTrigger = (
      <button className='bg-color3rd hover:!bg-color1st  text-white w-full font-semibold'>{collapsed ? 'Hiện' : 'Ẩn'}</button>
   );
   const {
   ...
   return (
      <>
         ...
         <Layout>
            ...
            >
               <HeaderAdmin />
               <Content className=' w-full px-6 pb-[20px] flex justify-center '>
                  <Outlet />
               </Content>
               <div>
