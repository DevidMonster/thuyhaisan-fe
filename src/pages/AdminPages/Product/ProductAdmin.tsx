            ...
            <div className='flex-1 flex lg:justify-center items-center flex-col mt-10 lg:w-[90%] w-full'>
               <div className='flex justify-between items-center w-[90%]'>
                  ...
                  <Link to='/manage/add-product'>
                     <button className='bg-color3rd hover:!bg-color1st  duration-100 hover:bg-greenPri600 text-white text-lg p-2 font-semibold rounded-lg flex justify-start items-center gap-2'>
               ...
               <div className='lg:w-[90%] min-h-[60vh] bg-white rounded-lg mt-5 w-[100%]'>
                  <header className='flex justify-start gap-4 items-center px-5 py-5'>
                     ...
                     <button
                        ...
                        className='border-[1px] border-[rgba(0,0,0,0.2)] rounded-xl p-2 text-color3rd hover:!bg-color1st  flex items-center gap-1 hover:-translate-y-1 duration-100'
                     >
                        <FilterIcon className='text-color3rd hover:!bg-color1st ' />
                        Lọc
                     </button>
                  </header>
                  <Table
