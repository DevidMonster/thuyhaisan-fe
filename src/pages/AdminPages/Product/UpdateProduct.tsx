...
const UpdateProduct = () => {
   ...
   useEffect(() => {
      setDiscountPrice(productPrice - ((productPrice * productDiscount) / 100))
   ...
   const handleSubmit = async () => {
      try {
         ...
         await handleUpdateProduct({ idProduct: id!, ...{ ...newFormData, productName } }).unwrap().then(() => {
                        ...
                        <div className='w-full flex justify-start items-center gap-2'>
                           ...
                           >
                              <Input
                                 ...
                                 value={productPrice}
                                 prefix={
                                    <span className='decoration-black underline absolute right-10 z-10'>vnd/sản phẩm</span>
                                 }
