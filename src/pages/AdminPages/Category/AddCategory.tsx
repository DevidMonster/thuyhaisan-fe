import { Form, Input, Divider, Layout, message, Select } from 'antd';
 ...
 const onHandleLogout = () => {
   ...
   const handleSubmit = async () => {
      try {
         ...
         form.setFieldValue('type', categoryType)
            ...
            >
               ...
               <div className='flex justify-end  gap-5 w-full'>
                  <Link to={'/manage/categories'}>
                     <button
                        type='button'
                        className='border-[1px] border-color3rd text-color3rd hover:!bg-color1st  py-2 px-5 rounded-xl font-semibold text-[1rem] hover:bg-color3rd hover:!bg-color1st  duration-200 hover:text-white'
                     >
                        Hủy
                     </button>
                  </Link>
