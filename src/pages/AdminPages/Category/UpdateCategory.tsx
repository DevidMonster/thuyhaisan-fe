...
import { Form, Input, Layout, UploadFile, Divider, message, Select } from 'antd';
 ...
 const onHandleLogout = () => {
   ...
   const handleSubmit = async () => {
      ...
      try {
         ...
         await handleUpdateCategory({ id: id!, ...newFormData, cateName: categoryName, type: categoryType || "default" }).unwrap().then(()=>{
            ...
            >
                  ...
                  <BlockForm title='Thông tin danh mục'>
                     <>
                        ...
                        <Form.Item name={'type'}>
                           ...
                           <Select
                              placeholder='Kiểu danh mục'
                              value={categoryType}
                              onChange={(e: string) => setCategoryType(e)}
                           >
               ...
               <div className='flex justify-end  gap-5 w-[90%]'>
                  <Link to={'/manage/categories'}>
                     <button
                        type='button'
                        className='border-[1px] border-[#80b235] text-color3rd hover:!bg-color1st  py-2 px-5 rounded-xl font-semibold text-[1rem] hover:bg-color3rd hover:!bg-color1st  duration-200 hover:text-white'
                     >
                        Hủy
                     </button>
                  </Link>
                  <Form.Item className='flex flex-col  !mb-0'>
                     <button
                        className='!bg-color3rd hover:!bg-color1st  !text-white py-2 px-5 rounded-xl font-semibold text-[1rem]'
                        type='submit'
                     >
                        Lưu
                     </button>
