 ...
 const onHandleLogout = () => {
   ...
   useEffect(
      () => {
         ...
         setCategoryType(data?.body?.data?.type || "normal")
         const newbody = {
            ...data?.body.data,
            _id: undefined,
            createdAt: undefined,
            ...
            >
               ...
               <div className='flex justify-end  gap-5 w-full'>
                  <Link to={'/manage/categories'}>
                     <button
                        type='button'
                        className='border-[1px] border-[#80b235] text-color3rd hover:!bg-color1st  py-2 px-5 rounded-xl font-semibold text-[1rem] duration-200 hover:text-white'
                     >
                        Hủy
                     </button>
                  </Link>
