               ...
               <div className='collection-sortby-option  group-hover/sort:visible invisible  group-hover/sort:top-[100%] group-hover/sort:opacity-[1] bg-white  absolute top-[calc(100%+10px)] opacity-0 left-0 right-0 border-[1px] border-[#eae4e8] transition-all duration-300'>
                  <ul className='collection-sortby-option-list py-[5px] px-[10px] z-[10]'>
                     <li
                        ...
                        className='collection-sortby-option-item relative cursor-pointer py-[4px] pr-[10px] pl-[25px] before:absolute before:left-[5px] before:top-[10px] before:w-[12px] before:h-[6px] before:border-[1.5px] before:border-color1st before:border-t-0 before:border-r-0 before:transition-all before:duration-300 before:scale-1  before:rotate-[-45deg]'
                     >
                        <span className='text-[14px] hover:text-color1st'>Sản phẩm nổi bật</span>
                     </li>
                     <li
                        onClick={() => {
                           setIsSale(true);
                        ...
                        className='collection-sortby-option-item relative cursor-pointer py-[4px] pr-[10px] pl-[25px] before:absolute before:left-[5px] before:top-[10px] before:w-[12px] before:h-[6px] before:border-[1.5px] before:border-color1st before:border-t-0 before:border-r-0 before:transition-all before:duration-300 before:scale-0  before:rotate-[-45deg]'
                     >
                        <span className='text-[14px] hover:text-color1st'>Sản phẩm hạ giá</span>
                     </li>
                     <li
                        onClick={() => {
                        ...
                        className='collection-sortby-option-item relative cursor-pointer py-[4px] pr-[10px] pl-[25px] before:absolute before:left-[5px] before:top-[10px] before:w-[12px] before:h-[6px] before:border-[1.5px] before:border-color1st before:border-t-0 before:border-r-0 before:transition-all before:duration-300 before:scale-0  before:rotate-[-45deg]'
                     >
                        <span className='text-[14px] hover:text-color1st'>Giá: Tăng dần</span>
                     </li>
                     <li
                         onClick={() => {
                        ...
                        className='collection-sortby-option-item relative cursor-pointer py-[4px] pr-[10px] pl-[25px] before:absolute before:left-[5px] before:top-[10px] before:w-[12px] before:h-[6px] before:border-[1.5px] before:border-color1st before:border-t-0 before:border-r-0 before:transition-all before:duration-300 before:scale-0  before:rotate-[-45deg]'
                     >
                        <span className='text-[14px] hover:text-color1st'>Giá: Giảm dần</span>
                     </li>
                     <li
                        onClick={() => {
                        ...
                        className='collection-sortby-option-item relative cursor-pointer py-[4px] pr-[10px] pl-[25px] before:absolute before:left-[5px] before:top-[10px] before:w-[12px] before:h-[6px] before:border-[1.5px] before:border-color1st before:border-t-0 before:border-r-0 before:transition-all before:duration-300 before:scale-0  before:rotate-[-45deg]'
                     >
                        <span className='text-[14px] hover:text-color1st'>Tên: A-Z</span>
                     </li>
                     <li
                        onClick={() => {
                        ...
                        className='collection-sortby-option-item relative cursor-pointer py-[4px] pr-[10px] pl-[25px] before:absolute before:left-[5px] before:top-[10px] before:w-[12px] before:h-[6px] before:border-[1.5px] before:border-color1st before:border-t-0 before:border-r-0 before:transition-all before:duration-300 before:scale-0  before:rotate-[-45deg]'
                     >
                        <span className='text-[14px] hover:text-color1st'>Tên: Z-A</span>
                     </li>
                     <li
                        onClick={() => {
                        ...
                        className='collection-sortby-option-item relative cursor-pointer py-[4px] pr-[10px] pl-[25px] before:absolute before:left-[5px] before:top-[10px] before:w-[12px] before:h-[6px] before:border-[1.5px] before:border-color1st before:border-t-0 before:border-r-0 before:transition-all before:duration-300 before:scale-0  before:rotate-[-45deg]'
                     >
                        <span className='text-[14px] hover:text-color1st'>Cũ nhất</span>
                     </li>
                     <li
                        onClick={() => {
                        ...
                        className='collection-sortby-option-item relative cursor-pointer py-[4px] pr-[10px] pl-[25px] before:absolute before:left-[5px] before:top-[10px] before:w-[12px] before:h-[6px] before:border-[1.5px] before:border-color1st before:border-t-0 before:border-r-0 before:transition-all before:duration-300 before:scale-0  before:rotate-[-45deg]'
                     >
                        <span className='text-[14px] hover:text-color1st'>Mới nhất</span>
                     </li>
                     <li
                        onClick={() => {
                        ...
                        className='collection-sortby-option-item relative cursor-pointer py-[4px] pr-[10px] pl-[25px] before:absolute before:left-[5px] before:top-[10px] before:w-[12px] before:h-[6px] before:border-[1.5px] before:border-color1st before:border-t-0 before:border-r-0 before:transition-all before:duration-300 before:scale-0  before:rotate-[-45deg]'
                     >
                        <span className='text-[14px] hover:text-color1st'>Bán chạy nhất</span>
                     </li>
                  </ul>
               </div>
            </div>
