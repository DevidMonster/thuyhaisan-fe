...
const CheckOutPage = () => {
   ...
   const onSubmit = async (data: IOrder) => {
      ...
      if (current == 2) {
         ...
         data.shippingAddress = data.province + ", " + data.districtName + ", " + data.ward + ", " + data.shippingAddress
      ...
      <>
         ...
         {cart?.products?.length > 0 ? <div>
                        ...
                        <div className='checkout-content'>
                           ...
                           <div style={{ marginTop: 24 }}>
                              {current < steps.length - 1 && (
                                 <Button
                                    className='bg-color3rd text-white hover:bg-color1st hover:!border-color1st hover:!text-black'
                                    type='text'
                              ...
                              {current > 0 && (
                                 <Button
                                    className=' hover:!border-color1st hover:!text-color1st '
                                    style={{ margin: '0 8px' }}
                                    onClick={() => prev()}
                                 >
                                    Trước đó
            ...
            <div className='cont  mx-auto flex-col px-[15px] 3xl:w-[1380px] 2xl:w-[1320px] xl:w-[1170px]   lg:w-[970px]  md:w-[750px] flex max-lg:flex-wrap items-start relative'>
               ...
               <Link to={"/collections"} className='block bg-color3rd text-white p-[10px] rounded-md m-auto'>
