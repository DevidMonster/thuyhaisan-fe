...
const CheckOut = () => {
   ...
   useEffect(() => {
      if (voucher._id) {
         ...
         if (voucher.miniMumOrder && temp < voucher.miniMumOrder) dispatch(remoteVoucher());
      }
   }, [cart]);
   useEffect(() => {
      if (voucher._id) {
   ...
   const goCheckOut = async () => {
      if (auth.user?._id) {
         ...
         await checkCartLocal(cartLocal).unwrap().then(() => {
            navigate("/checkout")
         }).catch((err: any) => {
            setIsModalOpen(true);
      ...
      <div>
         <div className='cart-total'>
            <div className='temporary items-center flex justify-between pb-[17px] border-b-[1px] border-[#e2e2e2]'>
               ...
               <span className='temporary font-bold text-redTextColor '>
                  {auth.user?._id
               ...
               <div>
                  <div className='discount flex justify-between items-center pb-[17px] border-b-[1px] border-[#e2e2e2] mt-[10px]'>
                     ...
                     <div className='discount-value'>
                        ...
                        {voucher.maxReduce && (
                           <span className='temporary font-bold  text-[14px] '>
                              {voucher.maxReduce && ((subtotal * voucher.percent) / 100) > voucher?.maxReduce
                                 ? '- ' +
            ...
            {!voucher._id ? <div className='discount-action mt-[30px] text-center'>
               ...
               <button
                  type='button'
                  className='block mt-[10px] hover:text-color1st cursor-pointer'
               ...
               <button
                  ...
                  type='button'
                  className='bg-color3rd  text-white py-[10px] px-[15px] rounded-[5px] mt-[15px] transition-color duration-300 hover:bg-color1st'
               >
                  Sử dụng
               </button>
            ...
            <div className='btn-checkout'>
               <button
                  onClick={goCheckOut}
                  type='button'
                  className=' bg-color3rd w-full  text-white py-[10px] px-[15px] rounded-[5px] mt-[25px] transition-color duration-300 hover:bg-color1st'
               >
                  Thanh toán
               </button>
            </div>
         ...
         <div>
            <Modal
               ...
               className=''
            >
               <div className='list-voucher  overflow-y-scroll max-h-[400px] flex flex-col gap-y-[10px]'>
                     ...
                     return (
                        <>
                           <div className=' py-[10px] shadow-[0px_0px_3px_rgba(0,0,0,0.15)] px-[16px]'>
                              ...
                              {!item.active &&
                                 <span className='text-red-500'>*Chưa đủ điều kiện để sử dụng</span>
                              }
                              <button
                                 ...
                                 className='my-[10px] bg-color3rd p-[5px] rounded-sm text-white float-right disabled:cursor-not-allowed disabled:bg-gray-400'
                                 type='button'
                              >
                                 Áp dụng
                              </button>
