      ...
      <div>
         <section className='section-best-product bg-[#f8f8f8] xl:py-[100px] lg:py-[80px] max-lg:py-[60px]'>
            <div className='best-product-header text-center xl:mb-[70px] lg:mb-[40px] max-lg:mb-[30px]'>
               <p className='best-product-title text-color3rd font-bold mb-[10px]'>BỘ SƯU TẬP TỐT NHẤT</p>
               <p className=' text-textRedColor font-bold  lg:text-[28px] md:text-[23px]  max-md:text-[20px]'>
