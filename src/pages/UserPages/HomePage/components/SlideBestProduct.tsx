                  ...
                  return (
                     <SwiperSlide key={index}>
                        <div className=' product-item md:p-[10px]  max-xl:mb-[18px]'>
                           <div className='product-wrap overflow-hidden group/product-wrap relative flex flex-col justify-between max-xl:pb-[40px]'>
                              {item.discount > 0 && (
                              ...
                              <Link to={'/products/' + item._id}>
                                 <p className='product-name font-bold md:mt-[10px] text-center md:text-[18px] max-md:text-[16px] line-clamp-2 break-words hover:text-redTextColor'>
                                    {item?.productName}
                              ...
                              <p className='price mt-[9px] flex items-center justify-center  text-center font-bold md:mb-[20px] max-md:mb-[10px] md:text-[18px]  text-colorbg-color3rd'>
