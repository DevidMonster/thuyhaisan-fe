         ...
         <div>
            {wishList?.items?.length <= 0 ? (
               <div className='cart-emty'>
                  <p className='cart-title xl:text-[30px]  border-[#e2e2e2] max-xl:text-[18px] text-redTextColor font-bold items-center text-center pb-[12px]'>
                     Không có sản phẩm yêu thích
                  </p>
                  <div className='start-shopping cart-title xl:text-[17px]  border-[#e2e2e2] max-xl:text-[18px] text-redTextColor font-bold flex justify-center items-center text-center pb-[12px]'>
                     <Link to={'/collections'}>
                        <button
                           type='button'
                           className=' bg-color3rd hover:bg-color1st  text-white py-[10px] px-[15px] rounded-[5px] mt-[25px]'
                        >
