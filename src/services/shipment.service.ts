...
const shipmentApi = createApi({
  ...
  tagTypes: ["shipment"],
  endpoints: (builder) => ({
    getAllShipmentExpand: builder.query<
      IResponseHasPaginate<IShipmentFull>,
      Partial<Omit<IQueryParam, "expand">>
    >({
      query: (params) => {
        return {
          url: "/shipments",
    ...
    updateShipment: builder.mutation<
      IResponse<IShipmentFull>,
      InputShipment & { idShipment: string }
    >({
