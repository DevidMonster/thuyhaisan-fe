...
const QuickView = ({ product_info }: QuickViewProp) => {
   ...
   const [inputWeight, setinputWeight] = useState<any>(1);
   ...
   const dec = () => {
      setinputWeight(Number(inputWeight) + 1);
   };
   const inc = () => {
      if (inputWeight > 1) {
         setinputWeight(Number(inputWeight) - 1);
      ...
      <>
         ...
         >
            ...
            >
               ...
               <div className='product-detail w-[calc(50%-10px)] lg:pt-[30px] max-lg:max-w-full max-lg:w-full'>
                  <div className='product-name'>
                     ...
                     <span className='product-origin text-[14px]'>
                        Xuất xứ: <strong className='text-color1st'>{product_info[0]?.originId.name}</strong>
                     </span>
                     <br />
                     <span className='product-origin text-[14px]'>
                        Số lượng còn lại: <strong className='text-color1st'>{totalWeight}</strong>
                     </span>
                  </div>
                  ...
                  {product_info[0]?.shipments.length > 0 ? (
                     <>
                        <div className='product-select mt-[20px] flex  w-full items-center'>
                           <div className='product-size-title min-w-[28%] text-[14px] font-[600]'>Số lượng:</div>
               ...
               >
                  <AiOutlineCloseCircle className=' text-[30px] max-lg:text-[40px]  group-hover/close-modal:fill-color1st'></AiOutlineCloseCircle>
               </button>
            </div>
         </section>
      </>
