...
import { MdNotificationsOff, MdOutlineLockReset } from 'react-icons/md';
...
const Header = () => {
   ...
   return (
      <>
         <div className='bg-color3rd h-[60px] text-white text-[px] flex items-center justify-between px-[20px]'>
            <p className='flex items-center'><CiLocationOn /><span className='ml-[10px]'> Địa chỉ: {info.address}</span></p>
            <p>
               <Link to={'/'} className='hover:underline'>Hướng dẫn thanh toán </Link>
               |
               <Link to={'/'} className='hover:underline'> Hướng dẫn mua hàng</Link>
            </p>
            <p className='flex items-center'><PhoneOutlined /><span className='ml-[10px]'>HOTLINE BÁN HÀNG: {info.phoneNumber}</span></p>
         </div>
         <header className='header sticky top-0 right-0 left-0 z-[5] transition-all duration-500 border-b-[1px] bg-white border-[#e2e2e2]  shadow-[0px_0px_10px_rgba(51,51,51,0.15)]'>
                     ...
                     <ul className='main-menu  flex max-xl:flex  max-xl:flex-col'>
                        ...
                        <div className='group/wrap'>
                           ...
                           >
                              ...
                              <div className='flex items-center group-hover:text-redTextColor max-xl:justify-between'>
                                 <span className='after:content-[""] xl:hidden after:w-[0] after:h-[2px] after:bg-redTetext-redTextColor after:max-xl:hidden after:transition-all after:duration-300 group-hover/menu-item:after:w-[calc(100%-30px)] after:block after:absolute after:bottom-0 after:left-[15px]'>
                                    Danh mục
                                 </span>
                                 <Link to='/collections'>
                                    <span className='after:content-[""] max-xl:hidden after:w-[0] after:h-[2px] after:bg-redTetext-redTextColor after:max-xl:hidden after:transition-all after:duration-300 group-hover/menu-item:after:w-[calc(100%-30px)] after:block after:absolute after:bottom-0 after:left-[15px]'>
                                       Danh mục
                                    </span>
                                 </Link>
                              ...
                              {data?.body.data.map((item, index) => {
                                 return (
                                    <Link
                                       ...
                                       className='group-hover/sub-menu:text-redTextColor text-[#6f6f6f] font-medium '
                                    >
                                       <li
                                          onClick={showMenuReponsive}
                              ...
                              <Popover
                                 ...
                                 content={
                                    <div className='max-h-[450px] min-w-[400px] overflow-scroll '>
                                       {clientNotification?.body?.data && clientNotification?.body?.data?.length > 0 ?
                                          ...
                                          <div className='text-gray-400 text-center pt-6'>
                                             <span className='flex justify-center items-center text-3xl'><MdNotificationsOff /></span>
